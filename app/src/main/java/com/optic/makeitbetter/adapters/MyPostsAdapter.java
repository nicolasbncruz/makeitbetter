package com.optic.makeitbetter.adapters;
...
import com.optic.makeitbetter.activities.PostDetailActivity;
import com.optic.makeitbetter.models.Post;
        ...
        mPostProvider.delete(postId).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    Toast.makeText(context, "El ejercicio se elimino correctamente", Toast.LENGTH_SHORT).show();
                } else {
