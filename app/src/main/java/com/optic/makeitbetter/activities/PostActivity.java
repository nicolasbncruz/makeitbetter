...
import com.optic.makeitbetter.providers.ImageProvider;
import com.optic.makeitbetter.providers.PostProvider;
import com.optic.makeitbetter.utils.FileUtil;
...
public class PostActivity extends AppCompatActivity {
    ...
    private void takePhoto(int requestCode) {
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (photoFile != null) {
                Uri photoUri = FileProvider.getUriForFile(PostActivity.this, "com.optic.makeitbetter", photoFile);
