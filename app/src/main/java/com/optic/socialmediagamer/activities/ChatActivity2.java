...
public class ChatActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLinearLayoutManager = new LinearLayoutManager(ChatActivity2.this);
...
//        checkIfChatExist();
        ...
        mUp_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                progressDialog = new ProgressDialog(ChatActivity2.this);
                progressDialog.show();
    ...
    public void onStart() {
        ...
        ViewedMessageHelper.updateOnline(true, ChatActivity2.this);
    }

    @Override
    protected void onPause() {
        super.onPause();
        ViewedMessageHelper.updateOnline(false, ChatActivity2.this);
    }
    ...
    private void getMessageChat() {
        ...
        FirestoreRecyclerOptions<Message> options =
                new FirestoreRecyclerOptions.Builder<Message>()
                        ...
                        .build();
        mAdapter = new MessagesAdapter(options, ChatActivity2.this);
            ...
            mMessagesProvider.create(message).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(ChatActivity2.this, "El mensaje no se pudo crear", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
                ...
                if (documentSnapshot.exists()) {
                    ...
                    if (documentSnapshot.contains("online")) {
                        ...
                        if (online) {
                            ...
                            String relativeTime = RelativeTime.getTimeAgo(lastConnect, ChatActivity2.this);
                    ...
                    if (documentSnapshot.contains("image_profile")) {
                        ...
                        if (mImageReceiver != null) {
                            if (!mImageReceiver.equals("")) {
                                Picasso.with(ChatActivity2.this).load(mImageReceiver).into(mCircleImageProfile);
                            }
                        }
                    }
                }
        ...
        mTokenProvider.getToken(idUser).addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                if (documentSnapshot.exists()) {
                    ...
                    Toast.makeText(ChatActivity2.this, "El token de notificaciones del usuario no existe", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
                    ...
                    public void onResponse(Call<FCMResponse> call, Response<FCMResponse> response) {
                        if (response.body() != null) {
                            if (response.body().getSuccess() == 1) {
                                ...
                                Toast.makeText(ChatActivity2.this, "La notificacion no se pudo enviar", Toast.LENGTH_SHORT).show();
                            }
                        }
                        else {
                            Toast.makeText(ChatActivity2.this, "La notificacion no se pudo enviar", Toast.LENGTH_SHORT).show();
