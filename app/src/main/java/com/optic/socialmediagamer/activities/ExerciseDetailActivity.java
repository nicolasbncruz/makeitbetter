...
//    PostProvider mPostProvider;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(ExerciseDetailActivity.this);
...
//        mPostProvider = new PostProvider();
        ...
        getPost();
        getNumberLikes();
        System.out.println("LOG: Se Crea la pantalla detalle Post");
    }
        ...
        mListener = mLikesProvider.getLikesByPost(mExtraPostId).addSnapshotListener(new EventListener<QuerySnapshot>() {
            ...
            public void onEvent(@Nullable QuerySnapshot queryDocumentSnapshots, @Nullable FirebaseFirestoreException e) {
                if (queryDocumentSnapshots != null) {
                    ...
                    if (numberLikes == 1) {
                        mTextViewLikes.setText(numberLikes + " Participante");
                    }
                    else {
    ...
    protected void onStart() {
        ...
        FirestoreRecyclerOptions<Comment> options =
                new FirestoreRecyclerOptions.Builder<Comment>()
                        ...
                        .build();
        mAdapter = new CommentAdapter(options, ExerciseDetailActivity.this);
        mRecyclerView.setAdapter(mAdapter);
        mAdapter.startListening();
        ViewedMessageHelper.updateOnline(true, ExerciseDetailActivity.this);
    }
    ...
    protected void onPause() {
        super.onPause();
        ViewedMessageHelper.updateOnline(false, ExerciseDetailActivity.this);
    }
    ...
    private void showDialogComment() {
        AlertDialog.Builder alert = new AlertDialog.Builder(ExerciseDetailActivity.this);
        alert.setTitle("¡COMENTARIO!");
        alert.setMessage("Ingresa tu comentario");

        final EditText editText = new EditText(ExerciseDetailActivity.this);
        ...
        RelativeLayout container = new RelativeLayout(ExerciseDetailActivity.this);
        ...
        alert.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if (!value.isEmpty()) {
                    ...
                    Toast.makeText(ExerciseDetailActivity.this, "Debe ingresar el comentario", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        mCommentsProvider.create(comment).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(ExerciseDetailActivity.this, "El comentario se creo correctamente", Toast.LENGTH_SHORT).show();
                }
                else {
                    Toast.makeText(ExerciseDetailActivity.this, "No se pudo crear el comentario", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
        ...
        mTokenProvider.getToken(mIdUser).addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                if (documentSnapshot.exists()) {
                            ...
                            public void onResponse(Call<FCMResponse> call, Response<FCMResponse> response) {
                                if (response.body() != null) {
                                    if (response.body().getSuccess() == 1) {
                                        Toast.makeText(ExerciseDetailActivity.this, "La notificacion se envio correcatemente", Toast.LENGTH_SHORT).show();
                                    }
                                    else {
                                        Toast.makeText(ExerciseDetailActivity.this, "La notificacion no se pudo enviar", Toast.LENGTH_SHORT).show();
                                    }
                                }
                                else {
                                    Toast.makeText(ExerciseDetailActivity.this, "La notificacion no se pudo enviar", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(ExerciseDetailActivity.this, "El token de notificaciones del usuario no existe", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void goToShowProfile() {
        if (!mIdUser.equals("")) {
            Intent intent = new Intent(ExerciseDetailActivity.this, UserProfileActivity.class);
    ...
    private void instanceSlider() {
        mSliderAdapter = new SliderAdapter(ExerciseDetailActivity.this, mSliderItems);
    ...
    private void getPost() {
        mPostProvider.getExerciseById(mExtraPostId).addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            @Override
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                if (documentSnapshot.exists()) {
                    ...
                    if (documentSnapshot.contains("timestamp")) {
                        ...
                        String relativeTime = RelativeTime.getTimeAgo(timestamp, ExerciseDetailActivity.this);
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                if (documentSnapshot.exists()) {
                    ...
                    if (documentSnapshot.contains("image_profile")) {
                        ...
                        Picasso.with(ExerciseDetailActivity.this).load(imageProfile).into(mCircleImageViewProfile);
                    }
                }
            }
        });
