...
import com.optic.socialmediagamer.activities.ChatActivity2;
...
public class ChatsAdapter2 extends FirestoreRecyclerAdapter<Chat, ChatsAdapter2.ViewHolder> {
    ...
    public ChatsAdapter2(FirestoreRecyclerOptions<Chat> options, Context context) {
        super(options);
...
//        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.cardview_chats, parent, false);
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.panel_prediccion, parent, false);
